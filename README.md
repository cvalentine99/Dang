...
### Knowledge Graph — 4-Layer API Ontology with Risk Paths
![Knowledge Graph](docs/screenshots/knowledge-graph.jpg)

### Alert Queue — Live Wazuh Alerts with Triage + Full Pipeline
![Alert Queue](docs/screenshots/alert-queue.jpg)

### Data Pipeline — Deterministic KG Extraction from OpenAPI Spec
![Data Pipeline](docs/screenshots/data-pipeline.jpg)

### Living Case — AI Hypothesis with Evidence, Theories & Response Actions
![Living Case](docs/screenshots/living-case.jpg)
